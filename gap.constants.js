...
const GAP_CHECKLIST = [
  ...
  { id:"4.2.3", clause:"4.2", title:"Cập nhật danh sách yêu cầu pháp lý định kỳ",                 weight:2, cat:"practice",    legal:"TT 09/2012 §4" },
  ...
  { id:"5.2.1", clause:"5.2", title:"Chính sách năng lượng được ban hành bởi lãnh đạo cao nhất", weight:3, cat:"doc",         legal:"TT 09/2012 §6" },
  { id:"5.2.2", clause:"5.2", title:"Chính sách cam kết cải tiến liên tục hiệu quả NL",          weight:2, cat:"doc",         legal:"" },
  { id:"5.2.3", clause:"5.2", title:"Chính sách cam kết đáp ứng yêu cầu pháp lý",               weight:3, cat:"doc",         legal:"Luật 50/2010" },
  ...
  { id:"5.3.1", clause:"5.3", title:"EMR (Energy Management Representative) được bổ nhiệm bằng văn bản", weight:3, cat:"doc",  legal:"TT 09/2012 §7; TT 38/2014" },
  { id:"5.3.2", clause:"5.3", title:"Nhóm quản lý năng lượng được thành lập",                    weight:2, cat:"doc",         legal:"TT 09/2012 §7" },
  ...
  { id:"6.2.1", clause:"6.2", title:"Mục tiêu năng lượng được thiết lập (đo lường được, có thời hạn)", weight:3, cat:"doc",  legal:"TT 09/2012 §9; QĐ 280/QĐ-TTg" },
  ...
  { id:"6.3.1", clause:"6.3", title:"Rà soát năng lượng dựa trên dữ liệu đo thực tế",           weight:3, cat:"measurement", legal:"TT 25/2020 §5; TT 09/2012 §8" },
  { id:"6.3.2", clause:"6.3", title:"SEU (Significant Energy Uses) được xác định và lập thành tài liệu", weight:3, cat:"doc", legal:"TT 09/2012 §8" },
  ...
  { id:"6.4.1", clause:"6.4", title:"EnPI được thiết lập phù hợp để theo dõi EnPI",              weight:3, cat:"measurement", legal:"TT 09/2012 §10" },
  ...
  { id:"6.6.1", clause:"6.6", title:"Kế hoạch thu thập dữ liệu NL được lập thành văn bản",       weight:2, cat:"measurement", legal:"TT 09/2012 §11" },
  { id:"6.6.2", clause:"6.6", title:"Người chịu TN và tần suất đo lường được xác định",          weight:2, cat:"measurement", legal:"" },
  { id:"6.6.3", clause:"6.6", title:"Thiết bị đo lường được hiệu chuẩn theo lịch định kỳ",       weight:3, cat:"measurement", legal:"TT 09/2012 §11" },
  // ── §7 Hỗ trợ ────────────────────────────────────────────
  ...
  { id:"7.4.1", clause:"7.4", title:"Quy trình trao đổi thông tin nội bộ về EnMS",                weight:1, cat:"practice",    legal:"TT 09/2012 §14" },
  { id:"7.5.1", clause:"7.5", title:"Tài liệu bắt buộc theo ISO 50001 đầy đủ và được kiểm soát", weight:3, cat:"doc",         legal:"TT 09/2012 §15" },
  { id:"7.5.2", clause:"7.5", title:"Hồ sơ được lưu trữ và bảo mật theo quy định",               weight:2, cat:"doc",         legal:"" },
  // ── §8 Vận hành ──────────────────────────────────────────
  { id:"8.1.1", clause:"8.1", title:"Tiêu chí vận hành cho các SEU được thiết lập",               weight:3, cat:"practice",    legal:"TT 09/2012 §16" },
  ...
  { id:"8.2.1", clause:"8.2", title:"Hiệu quả NL được xem xét trong thiết kế/sửa đổi thiết bị",  weight:2, cat:"practice",    legal:"Luật 50/2010 §26-30" },
  ...
  // ── §9 Đánh giá ──────────────────────────────────────────
  { id:"9.1.1", clause:"9.1", title:"Theo dõi EnPI định kỳ và ghi nhận kết quả",                  weight:3, cat:"measurement", legal:"TT 09/2012 §18; TT 25/2020" },
  ...
  { id:"9.1.3", clause:"9.1", title:"Báo cáo sử dụng NL hàng năm nộp cho cơ quan quản lý",       weight:3, cat:"legal",       legal:"TT 09/2012 §18; NĐ 21/2011 §20" },
  ...
  { id:"9.3.1", clause:"9.3", title:"Xem xét lãnh đạo được thực hiện định kỳ (ít nhất 1 lần/năm)", weight:3, cat:"leadership",legal:"TT 09/2012 §20" },
...
const RISK_CATEGORIES = [
  {
    ...
    desc:"Rủi ro không đáp ứng yêu cầu Luật 50/2010, TT 09/2012, TT 25/2020 và các văn bản liên quan",
    color:"C0392B",
    items:[
      { id:"RL-01", risk:"Chưa xác định cơ sở thuộc diện trọng điểm (≥1000 TOE/năm)",               ref:"TT 09/2012 Điều 4",    likelihood:0, impact:0, control:"" },
      { id:"RL-02", risk:"Không nộp báo cáo NL hàng năm cho BCT",                                    ref:"TT 09/2012 Điều 18",   likelihood:0, impact:0, control:"" },
      ...
      { id:"RL-06", risk:"Không lập kế hoạch sử dụng NL và TKNL hàng năm",                          ref:"TT 09/2012 Điều 9",    likelihood:0, impact:0, control:"" },
...
const PROCESS_MAP = [
  {
    ...
    std_ref:["ISO 50001 §6.2","TT 09/2012 §9","QĐ 280/QĐ-TTg"],
  ...
  },
  {
    ...
    std_ref:["ISO 50001 §9.3","TT 09/2012 §20"],
