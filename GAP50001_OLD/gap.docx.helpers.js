...
const P = (text, o={}) => new Paragraph({
  ...
  children:[new TextRun({
    text:String(text||""), font:"Arial", size:o.sz||22,
...
const H3 = t => new Paragraph({ heading:HeadingLevel.HEADING_3, spacing:{before:160,after:80},
  children:[new TextRun({ text:t, font:"Arial", size:23, bold:true, color:C.teal })],
});
const SP  = () => P("", {a:80});
...
const TH = (headers, widths, hc=C.navy) => new TableRow({ tableHeader:true,
  children:[...headers.map((h,i) => new TableCell({
    ...
    children:[P(h,{sz:18,bold:true,col:C.white,c:true})],
  }))],
});
const TR = (cells, widths, ri=0) => new TableRow({ children:cells.map((cell,i) => new TableCell({
  ...
  children: Array.isArray(cell)?cell:[P(String(cell||""),{sz:19})],
})) });
...
const ScoreCell = (score, w=1200) => new TableCell({ width:{size:w,type:WidthType.DXA},
  ...
  children:[P(scoreLabel(score),{sz:17,bold:true,c:true,col:scoreColor(score)})],
});
...
const mkHeader = d => new Header({ children:[new Paragraph({
  ...
  children:[
    new TextRun({ text:`${d.verifier?.org||"ISO 50001 GAP Survey"}  |  `, font:"Arial", size:17, color:C.blue, bold:true }),
    new TextRun({ text:`BÁO CÁO KHẢO SÁT GAP ISO 50001:2018  |  ${d.meta?.ref_no||"—"}  |  `, font:"Arial", size:17, color:C.grey2 }),
    new TextRun({ text:d.meta?.confidential||"CONFIDENTIAL", font:"Arial", size:15, color:C.red, bold:true }),
  ],
})]});
const mkFooter = d => new Footer({ children:[new Paragraph({
  ...
  children:[
    new TextRun({ text:`${d.client?.name||"—"}  |  Ngày khảo sát: ${d.meta?.survey_date||"—"}  |  Trang `, font:"Arial", size:15, color:C.grey2 }),
    new SimpleField("PAGE",{size:15}),
  ],
})]});
...
const DOC_STYLES = {
  ...
  paragraphStyles:[
    { id:"Heading1", name:"Heading 1", basedOn:"Normal", next:"Normal", quickFormat:true,
      run:{ font:"Arial", size:34, bold:true, color:C.navy },
      paragraph:{ spacing:{before:360,after:180}, outlineLevel:0,
        border:{ bottom:{ style:BorderStyle.SINGLE, size:10, color:C.blue, space:2 }}}},
    { id:"Heading2", name:"Heading 2", basedOn:"Normal", next:"Normal", quickFormat:true,
      run:{ font:"Arial", size:26, bold:true, color:C.blue },
      paragraph:{ spacing:{before:220,after:110}, outlineLevel:1 }},
    { id:"Heading3", name:"Heading 3", basedOn:"Normal", next:"Normal", quickFormat:true,
      run:{ font:"Arial", size:23, bold:true, color:C.teal },
