...
const surveySchema = new mongoose.Schema(
  {
    ...
    client: {
      ...
      scope_geographical: String,     // 5.1 Phạm vi địa lý
      scope_energy: { type: [String], default: [] },  // 5.2 Phạm vi nguồn năng lượng (dropdown CRUD, truy vấn MongoDB)
      scope_product: String,          // 5.3 Phạm vi sản phẩm
      scope_control_method: String,   // 5.4 Phương thức kiểm soát hệ thống
    },
    verifier: {
      org: String,
      accred: String,
