...
export const RISK_IMPACT = [
  ...
  { v:3, l:"3 — Vừa" },
  { v:4, l:"4 — Lớn" },
  { v:5, l:"5 — Rất lớn / Nghiêm trọng" },
];

export const VERIFIER_ORGS = [
  ["Công ty TNHH Tư vấn Năng lượng Thế Kỷ", "Công ty TNHH Tư vấn Năng lượng Thế Kỷ (CEEC)"],
  ["Trung tâm Khuyến công & Tư vấn phát triển công nghiệp", "Trung tâm Khuyến công & Tư vấn phát triển công nghiệp"],
  ["Công ty CP Tư vấn Năng lượng & Môi trường", "Công ty CP Tư vấn Năng lượng & Môi trường (VNEEC)"],
  ["Công ty TNHH Tư vấn ENERTEAM", "Công ty TNHH Tư vấn ENERTEAM"],
  ["Viện Năng lượng (IE)", "Viện Năng lượng (IE)"],
  ["Khác", "Đơn vị tư vấn khác..."],
];

export const VERIFIER_PROGRAMS = [
  ["Chương trình VNEEP3 (2019-2030)", "Chương trình VNEEP3 (2019-2030)"],
  ["Chương trình Bảo vệ Môi trường & TKNL cấp tỉnh/TP", "Chương trình Bảo vệ Môi trường & TKNL cấp tỉnh/TP"],
  ["Dự án Tài trợ JICA", "Dự án Tài trợ JICA (Nhật Bản)"],
  ["Dự án Tài trợ GIZ", "Dự án Tài trợ GIZ (Đức)"],
  ["Dự án Tài trợ USAID", "Dự án Tài trợ USAID (Mỹ)"],
  ["Doanh nghiệp tự triển khai", "Doanh nghiệp tự triển khai / Nội bộ"],
  ["Khác", "Chương trình khác..."],
];
...
export const STEPS = [
  ...
  { id:"meters",   icon:"🎛️", label:"Thiết bị đo lường"  },
...
export const GAP_CHECKLIST = [
  ...
  { id:"5.3.4",clause:"5.3",title:"EMR có phân bổ thời gian và đường báo cáo lãnh đạo rõ ràng",weight:2,cat:"practice",legal:"TT 38/2014" },
...
export const ENERGY_CONVERSION_FACTORS = [
  { id: "electricity", name: "Điện năng", unit: "1000 kWh", factor: 0.1543 },
  { id: "coal_coc", name: "Than cốc", unit: "Tấn", factor: 0.725 },
  { id: "coal_1_2", name: "Than cám loại 1,2", unit: "Tấn", factor: 0.7 },
  { id: "coal_3_4", name: "Than cám loại 3,4", unit: "Tấn", factor: 0.6 },
  { id: "coal_5_6", name: "Than cám loại 5,6", unit: "Tấn", factor: 0.5 },
  { id: "do_tan", name: "Dầu DO (Tấn)", unit: "Tấn", factor: 1.02 },
  { id: "do_lit", name: "Dầu DO (1000 lít)", unit: "1000 lít", factor: 0.88 },
  { id: "fo_tan", name: "Dầu FO (Tấn)", unit: "Tấn", factor: 0.99 },
  { id: "fo_lit", name: "Dầu FO (1000 lít)", unit: "1000 lít", factor: 0.94 },
  { id: "lpg", name: "LPG", unit: "Tấn", factor: 1.09 },
  { id: "ng", name: "Khí tự nhiên (NG)", unit: "1000 m3", factor: 0.9 },
  { id: "gasoline_tan", name: "Xăng ôtô-xe máy (Tấn)", unit: "Tấn", factor: 1.05 },
  { id: "gasoline_lit", name: "Xăng ôtô-xe máy (1000 lít)", unit: "1000 lít", factor: 0.83 },
  { id: "jet_fuel", name: "Nhiên liệu phản lực (Jet fuel)", unit: "Tấn", factor: 1.05 },
  { id: "biomass", name: "Trấu/Sinh khối rắn khác", unit: "Tấn", factor: 0 },
  { id: "wood", name: "Gỗ/Gỗ phế phẩm", unit: "Tấn", factor: 0 },
];
...
// ═══════════════════════════════════════════════════════════
// EQUIPMENT_TYPES — thống nhất với backend gap.constants.js
// Schema: { id, name, icon, checks[], ref_std }
// ═══════════════════════════════════════════════════════════
export const EQUIPMENT_TYPES = [
  // ── Động cơ điện ─────────────────────────────────────────────────
  { id:"EQ-MAC", name:"Động cơ điện xoay chiều",  icon:"⚙️",  checks:["Công suất định mức vs thực tế (kW)","Cấp hiệu suất IE (IE1/IE2/IE3/IE4)","Hệ số tải vận hành (%)","Biến tần VFD đã lắp chưa","Thời gian chạy không tải/ngày","Chế độ bảo trì định kỳ"],                   ref_std:"TT 36/2016; QĐ 1725/QĐ-BCT; IEC 60034-30-1" },
  { id:"EQ-MDC", name:"Động cơ điện một chiều",   icon:"🔋",  checks:["Điện áp & dòng định mức","Tình trạng chổi than / cổ góp","Hiệu suất so với định mức (%)","Bộ điều khiển DC Drive còn tốt không","Tổn thất điện trở phần ứng"],                                               ref_std:"ISO 50001 §8.1; IEC 60034" },
  { id:"EQ-SRV", name:"Động cơ Servo",            icon:"🎯",  checks:["Độ chính xác định vị (mm/°)","Tổn thất công suất khi giữ vị trí","Bộ mã hóa Encoder còn chính xác","Nhiệt độ driver Servo","Tần suất gia tốc/giảm tốc"],                                                     ref_std:"ISO 50001 §8.1" },
  { id:"EQ-STP", name:"Động cơ bước",             icon:"🔩",  checks:["Mô-men tải vs định mức","Tổn thất bước (missing step)","Dòng điện giữ vị trí (holding current)","Nhiệt độ driver","Bộ điều khiển vi bước (microstepping)"],                                                  ref_std:"ISO 50001 §8.1" },
  { id:"EQ-REL", name:"Động cơ từ trở",           icon:"🧲",  checks:["Hiệu suất so với IE4","Độ rung & tiếng ồn","Bộ điều khiển SRM drive","Nhiệt độ vận hành","Chu kỳ bảo trì"],                                                                                                    ref_std:"ISO 50001 §8.1; IEC 60034-30-1" },
  { id:"EQ-CGX", name:"Động cơ ghi xích",         icon:"⛓️",  checks:["Tốc độ ghi xích vs tải lò","Tổn thất truyền động xích","Độ căng xích & bôi trơn","Công suất tiêu thụ thực tế","Nhiệt độ hộp số"],                                                                             ref_std:"TT 25/2020; ISO 50002" },
  // ── Bơm & Van ────────────────────────────────────────────────────
  { id:"EQ-PMP", name:"Bơm",                      icon:"💧",  checks:["Hiệu suất thủy lực tổng thể (%)","Rò rỉ đầu nối, van, bích mặt bích","VFD điều chỉnh lưu lượng đã lắp chưa","Áp lực vận hành vs thiết kế (bar)","Tổn thất đường ống (độ dài, co, van)","Chu kỳ bảo trì cơ học"], ref_std:"ISO 50001 §8.1; HI 40.6" },
  { id:"EQ-VMC", name:"Van cơ",                   icon:"🔧",  checks:["Độ kín van (rò rỉ qua van khi đóng)","Tổn thất áp qua van (ΔP)","Đặc tính lưu lượng vs độ mở","Vật liệu thân van phù hợp lưu chất","Chu kỳ kiểm tra & bôi trơn"],                                             ref_std:"ISO 50001 §8.1" },
  { id:"EQ-VOO", name:"Van điện ON-OFF",           icon:"🔌",  checks:["Thời gian đóng/mở (s)","Điện áp cuộn dây (VAC/VDC)","Rò rỉ nội khi đóng hoàn toàn","Nhiệt độ cuộn dây khi vận hành","Chu kỳ đóng/mở & tuổi thọ"],                                                          ref_std:"ISO 50001 §8.1" },
  { id:"EQ-VPR", name:"Van tỷ lệ",                icon:"📊",  checks:["Đặc tính tuyến tính / equal % / quick open","Tín hiệu điều khiển (4-20mA / 0-10V)","Độ trễ (hysteresis %)","Rò rỉ nội & ngoại","Bộ positioner còn chính xác không"],                                          ref_std:"ISO 50001 §8.1" },
  // ── Máy nén khí & Sấy ────────────────────────────────────────────
  { id:"EQ-CPS", name:"Máy nén khí Pittong",      icon:"🔄",  checks:["Áp suất đầu ra vs đặt (bar)","Rò rỉ đường ống & van an toàn","Nhiệt độ dầu bôi trơn","Hiệu suất thể tích (%)","Thời gian tải/giảm tải trong ca","Chu kỳ thay dầu & lọc"],                                    ref_std:"ISO 50001 §8.1; ISO 1217" },
  { id:"EQ-CSY", name:"Máy nén khí trục vít YD",  icon:"🌪️", checks:["Áp suất vận hành (bar) vs đặt","Nhiệt độ đầu ra khí & dầu","Hệ thống thu hồi nhiệt (heat recovery)","Chế độ điều tải (load/unload/VSD)","Rò rỉ khí nén toàn hệ thống","Bộ lọc đầu vào & tách dầu"],       ref_std:"ISO 50001 §8.1; ISO 1217" },
  { id:"EQ-CIV", name:"Máy nén khí INVT",         icon:"🔁",  checks:["Tần số biến tần thực tế (Hz)","Áp suất set-point vs thực (bar)","Tiêu thụ điện kWh/m³ khí sản xuất","Nhiệt độ cuộn dây motor","Rò rỉ hệ thống khí nén"],                                                      ref_std:"ISO 50001 §8.1; ISO 1217" },
  { id:"EQ-ADR", name:"Máy sấy khí",              icon:"💨",  checks:["Điểm sương (dew point °C) đạt yêu cầu","Áp suất tổn thất qua máy sấy (ΔP)","Chu kỳ tái sinh desiccant","Nhiệt độ đầu vào khí ẩm","Tiêu thụ điện hoặc hơi tái sinh"],                                         ref_std:"ISO 50001 §8.1" },
  // ── Quạt ─────────────────────────────────────────────────────────
  { id:"EQ-FAX", name:"Quạt hướng tâm",           icon:"🌀",  checks:["Lưu lượng thực tế vs thiết kế (m³/h)","VFD đã lắp chưa","Hệ số tải vận hành (%)","Cân bằng động cánh quạt","Bộ lọc / tắc nghẽn ảnh hưởng lưu lượng","Dây đai & hộp số tổn thất"],                          ref_std:"ISO 50001 §8.1" },
  { id:"EQ-FCF", name:"Quạt ly tâm",              icon:"🌬️", checks:["Đường cong đặc tính quạt (Q-H)","VFD điều chỉnh tốc độ","Độ rung & tiếng ồn (dB)","Hiệu suất tổng thể η (%)","Tổn thất đường ống phân phối"],                                                                  ref_std:"ISO 50001 §8.1" },
  { id:"EQ-FSA", name:"Quạt cấp gió",             icon:"➡️",  checks:["Lưu lượng gió cấp (m³/h) vs thiết kế","Nhiệt độ không khí cấp","VFD hoặc van điều chỉnh","Áp suất tĩnh (Pa)","Bộ lọc không khí (clogging)"],                                                                   ref_std:"ISO 50001 §8.1" },
  { id:"EQ-FSE", name:"Quạt hút khói",            icon:"🏭",  checks:["Lưu lượng khói hút (m³/h)","Nhiệt độ khói đầu vào (°C)","Cánh quạt chịu nhiệt & ăn mòn","VFD điều chỉnh","Rò rỉ duct khói"],                                                                                   ref_std:"TT 25/2020; ISO 50002" },
  { id:"EQ-FCT", name:"Quạt tháp giải nhiệt",     icon:"🌡️", checks:["Lưu lượng gió qua tháp (m³/h)","Nhiệt độ nước vào/ra tháp (°C)","Hiệu suất giải nhiệt (kW/RT)","VFD điều chỉnh theo tải","Tình trạng cánh quạt & bộ phân phối nước"],                                         ref_std:"ISO 50001 §8.1" },
  // ── Mỏ đốt ───────────────────────────────────────────────────────
  { id:"EQ-BGS", name:"Mỏ đốt gas",               icon:"🔥",  checks:["Tỷ lệ không khí dư λ (O₂% khói lò)","Nhiệt trị gas tiêu thụ (MJ/Nm³)","Áp suất gas đầu vào (mbar)","Nhiệt độ khói lò ra (°C)","Hệ thống thu hồi nhiệt preheating","Hiệu suất nhiệt lò (%)"],                ref_std:"TT 25/2020; ISO 50002" },
  { id:"EQ-BOL", name:"Mỏ đốt dầu",               icon:"🛢️", checks:["Tỷ lệ không khí dư λ (O₂% khói)","Độ nhớt dầu đốt (cSt) vs nhiệt độ gia nhiệt","Áp suất phun dầu (bar)","Nhiệt độ khói lò ra (°C)","Hiệu suất nhiệt (%)","Hệ thống thu hồi nhiệt"],                          ref_std:"TT 25/2020; ISO 50002" },
  // ── Hệ thống lạnh & ĐHKK ─────────────────────────────────────────
  { id:"EQ-CHL", name:"Chiller",                  icon:"❄️",  checks:["COP / EER thực tế vs định mức","Nhiệt độ nước lạnh cấp/hồi (°C)","Nhiệt độ nước giải nhiệt vào/ra (°C)","Trạng thái gas lạnh & áp suất","Chu kỳ vệ sinh dàn ngưng tụ & bay hơi","BMS điều khiển theo tải"], ref_std:"TT 36/2016; ISO 50001 §8.1" },
  { id:"EQ-ACU", name:"Điều hoà",                 icon:"🌡️", checks:["EER / SEER so với nhãn NL","Nhiệt độ đặt phòng (≥26°C hè)","Trạng thái gas lạnh & filter","Cách nhiệt tòa nhà (tường, kính)","Chế độ inverter hay ON-OFF","Vệ sinh dàn lạnh định kỳ"],                       ref_std:"TT 36/2016 Nhãn NL; TCVN 9257" },
  { id:"EQ-CTW", name:"Tháp giải nhiệt",          icon:"🏗️", checks:["Hiệu quả làm mát (Approach Temperature °C)","Tình trạng đệm tản nhiệt (fill media)","Chất lượng nước (conductivity, scale)","Rò rỉ nước ra môi trường","Chu kỳ súc xả blowdown","Vận hành quạt tháp"],       ref_std:"ISO 50001 §8.1" },
  // ── Chiếu sáng ───────────────────────────────────────────────────
  { id:"EQ-LMV", name:"Đèn cao áp thuỷ ngân",     icon:"💡",  checks:["Công suất thực tế (W) vs nhãn","Quang thông còn lại (lm) sau tuổi thọ","Kế hoạch thay thế bằng LED","Hệ số chiếu sáng (lux) tại mặt làm việc","Thời gian cháy/ngày (h)"],                                     ref_std:"QĐ 1725/QĐ-BCT; TCVN 7114" },
  { id:"EQ-LHL", name:"Đèn Halogen",              icon:"🔆",  checks:["Công suất (W) vs chiếu sáng lux","Nhiệt độ bóng & chóa (°C)","Kế hoạch thay thế bằng LED","Thời gian cháy/ngày","Chỉ số CRI & nhiệt độ màu"],                                                                  ref_std:"QĐ 1725/QĐ-BCT" },
  { id:"EQ-LFD", name:"Đèn LED pha",              icon:"🔦",  checks:["Công suất (W) vs quang thông (lm)","Chỉ số hiệu suất sáng (lm/W)","Cảm biến chuyển động / lịch bật tắt","Nhiệt độ vỏ tản nhiệt (°C)","Góc chiếu & độ đồng đều"],                                              ref_std:"QĐ 1725/QĐ-BCT; TCVN 7114" },
  { id:"EQ-LED", name:"Đèn LED",                  icon:"💡",  checks:["Hiệu suất sáng (lm/W) ≥ 100 lm/W","Chỉ số hoàn màu CRI ≥ 80","Mức chiếu sáng lux tại mặt làm việc vs TCVN 7114","Cảm biến tự động (PIR / ánh sáng tự nhiên)","Lịch vận hành & điều chỉnh dimming"],          ref_std:"QĐ 1725/QĐ-BCT; TCVN 7114" },
  { id:"EQ-LFU", name:"Đèn huỳnh quang",          icon:"🕯️", checks:["Công suất (W) vs nhãn","Kế hoạch thay thế bằng LED","Tình trạng chấn lưu (ballast)","Mức lux hiện tại","Thời gian cháy thực tế/ngày (h)"],                                                                      ref_std:"QĐ 1725/QĐ-BCT" },
  // ── Điện & Điều khiển ────────────────────────────────────────────
  { id:"EQ-VFD", name:"Biến tần",                 icon:"📟",  checks:["Tần số đầu ra thực tế (Hz)","Dòng điện đầu ra vs định mức (A)","Nhiệt độ mô-đun IGBT (°C)","Hài sóng THD < 5%","Bộ lọc EMC đầu vào","Chu kỳ vệ sinh mạch làm mát"],                                          ref_std:"IEC 61800-9; ISO 50001 §8.1" },
  { id:"EQ-SFS", name:"Khởi động mềm",            icon:"🎚️", checks:["Dòng khởi động giới hạn (A vs Idef)","Thời gian ramping up/down (s)","Nhiệt độ thiết bị khi vận hành","Bypass contactor sau khởi động","Bảo vệ quá tải & mất pha"],                                            ref_std:"IEC 60947-4-2; ISO 50001 §8.1" },
  { id:"EQ-CTR", name:"Contactors",               icon:"⚡",  checks:["Cấp dòng định mức (A)","Tuổi thọ cơ học & điện (số thao tác)","Tình trạng tiếp điểm (ăn mòn/bụi bẩn)","Điện áp cuộn dây (VAC)","Nhiệt độ vận hành trong tủ"],                                                ref_std:"IEC 60947-4-1" },
  { id:"EQ-CAP", name:"Tụ bù",                    icon:"🔋",  checks:["Hệ số công suất cosφ trước/sau bù","Dung lượng bù (kVAR) vs tải thực","Nhiệt độ tụ điện (°C)","Tình trạng thiết bị bảo vệ quá áp","Kiểm tra rò rỉ điện môi","Chu kỳ kiểm tra định kỳ"],                     ref_std:"IEC 60831; ISO 50001 §6.3" },
  { id:"EQ-TRF", name:"Máy biến áp",              icon:"🔌",  checks:["Hệ số tải MBA (%) — tối ưu 60-80%","Tổn thất không tải (W) lõi thép","Nhiệt độ dầu cách điện (°C)","Hệ số công suất tại điểm đầu nguồn","Tụ bù công suất phản kháng","Vận hành ngoài giờ cao điểm"],         ref_std:"ISO 50001 §6.3; TCVN 6306" },
  { id:"EQ-PNL", name:"Tủ điện",                  icon:"🗄️", checks:["Nhiệt độ bên trong tủ (°C) < 40°C","Dây đấu chắc chắn, không bị oxy hóa","Hệ thống đo lường (đồng hồ điện, power meter)","Nhãn mạch / sơ đồ đơn tuyến đầy đủ","Hệ thống làm mát tủ (quạt, A/C tủ)"],       ref_std:"IEC 61439; ISO 50001 §6.6" },
  // ── Vận chuyển nội bộ ────────────────────────────────────────────
  { id:"EQ-FLD", name:"Xe nâng dầu DO",           icon:"🚜",  checks:["Mức tiêu thụ nhiên liệu L/h hay L/tấn.km","Tình trạng động cơ diesel (khói, rung)","Áp suất lốp","Hệ thống thủy lực nâng hạ (rò rỉ)","Kế hoạch thay thế xe điện"],                                           ref_std:"ISO 50001 §8.1; NĐ 06/2022" },
  { id:"EQ-FLE", name:"Xe nâng điện",             icon:"🔋",  checks:["Dung lượng pin (Ah) vs tuổi thọ","Thời gian sạc & tiêu thụ điện (kWh/chu kỳ)","Hiệu suất động cơ điện kéo","Tình trạng bộ sạc (charger efficiency %)","Nhiệt độ pin khi vận hành"],                           ref_std:"ISO 50001 §8.1" },
  { id:"EQ-CRN", name:"Cầu trục",                 icon:"🏗️", checks:["Công suất động cơ nâng/di chuyển (kW)","Hệ số sử dụng thực tế vs định mức","Biến tần VFD điều khiển tốc độ","Tổn thất phanh & hệ thống tái sinh","Chu kỳ kiểm định & bôi trơn"],                             ref_std:"TCVN 4244; ISO 50001 §8.1" },
  // ── Khác ─────────────────────────────────────────────────────────
  { id:"EQ-OTH", name:"Thiết bị khác",            icon:"🔧",  checks:["Tên thiết bị & mã hiệu","Công suất lắp đặt (kW)","Hiệu suất hiện tại so với định mức (%)","Tuổi thọ & kế hoạch thay thế","Tiêu chí vận hành tiết kiệm NL","Nhãn năng lượng (nếu có)"],                        ref_std:"ISO 50001 §8" },
];

// ═══════════════════════════════════════════════════════════
// ZONE_TYPES — thống nhất với backend gap.constants.js
// Schema: { id, name, icon, desc? }
// ═══════════════════════════════════════════════════════════
export const ZONE_TYPES = [
  ...
  { id:"ZN-PNT", name:"Khu vực buồng phun sơn",             icon:"🎨", desc:"Phun sơn, phủ bề mặt" },
  { id:"ZN-PS1", name:"Khu vực lò sấy sơn lót",             icon:"🌡️", desc:"Sấy lớp sơn lót" },
  { id:"ZN-PS2", name:"Khu vực lò sấy sơn hoàn thiện",      icon:"✨", desc:"Sấy lớp sơn hoàn thiện" },
  { id:"ZN-BOI", name:"Khu vực lò hơi",                     icon:"💨", desc:"Nồi hơi, cung cấp hơi nước" },
  { id:"ZN-CHL", name:"Khu vực Chiller / làm lạnh",         icon:"❄️",  desc:"Chiller, tháp giải nhiệt" },
  { id:"ZN-PMP", name:"Khu vực Trạm bơm",                   icon:"💧", desc:"Bơm nước, bơm hóa chất" },
  { id:"ZN-PRS", name:"Khu vực Máy dập",                    icon:"🔨", desc:"Dập, ép kim loại" },
  { id:"ZN-CUT", name:"Khu vực Máy cắt",                    icon:"✂️",  desc:"Cắt phôi, cắt tấm" },
  { id:"ZN-LSR", name:"Khu vực Máy cắt Laser",              icon:"🔆", desc:"Cắt laser CNC" },
  { id:"ZN-BND", name:"Khu vực Máy uốn",                    icon:"〰️", desc:"Uốn, cuộn ống, tấm" },
  { id:"ZN-CNC", name:"Khu vực Máy CNC",                    icon:"⚙️",  desc:"Gia công CNC, tiện, phay" },
  { id:"ZN-WLD", name:"Khu vực Hàn tay",                    icon:"🔧", desc:"Hàn MIG, TIG, điện tay" },
  { id:"ZN-RWL", name:"Khu vực Hàn Robot",                  icon:"🤖", desc:"Hàn tự động, robot hàn" },
  { id:"ZN-CMP", name:"Khu vực Máy nén khí",                icon:"🌪️", desc:"Máy nén khí, khí nén tổng" },
  { id:"ZN-SBL", name:"Khu vực Phun bi",                    icon:"🔵", desc:"Làm sạch bề mặt bằng bi" },
  { id:"ZN-SND", name:"Khu vực Phun cát",                   icon:"🟤", desc:"Làm sạch bề mặt bằng cát" },
  { id:"ZN-REF", name:"Hệ thống làm lạnh / kho lạnh",       icon:"🧊", desc:"Kho lạnh, bảo quản lạnh" },
  { id:"ZN-LGT", name:"Khu vực chiếu sáng nhà xưởng",       icon:"💡", desc:"Hệ thống chiếu sáng công nghiệp" },
  { id:"ZN-OFF", name:"Văn phòng / hành chính",              icon:"🏢", desc:"Khối văn phòng, phòng họp" },
  { id:"ZN-WRH", name:"Kho nguyên liệu / thành phẩm",       icon:"📦", desc:"Kho chứa, logistics nội bộ" },
  { id:"ZN-WTR", name:"Trạm bơm / xử lý nước",              icon:"🚿", desc:"Xử lý nước cấp, nước thải" },
  { id:"ZN-ELC", name:"Trạm biến áp / phòng điện",          icon:"⚡",  desc:"Điện lực, tủ điện phân phối" },
  { id:"ZN-ENV", name:"Khu vực xử lý khí thải / môi trường",icon:"♻️",  desc:"Lọc bụi, xử lý khói thải" },
  { id:"ZN-EXT", name:"Bãi đậu xe / chiếu sáng ngoài trời", icon:"🚗", desc:"Hạ tầng ngoại vi, đèn đường" },
  { id:"ZN-OTH", name:"Khu vực khác",                       icon:"📍", desc:"Khu vực chưa phân loại" },
];

// ═══════════════════════════════════════════════════════════
// METER OPTIONS
// ═══════════════════════════════════════════════════════════
export const METER_LOAD_TYPES = [
  ["Nhà xưởng", "Nhà xưởng"],
  ["Line sản xuất", "Line sản xuất"],
  ["Cụm thiết bị", "Cụm thiết bị"],
  ["Thiết bị/Máy móc", "Thiết bị/Máy móc"],
];

export const METER_TYPES = [
  ["Điện tử không truyền thông", "Điện tử không truyền thông"],
  ["Điện tử có truyền thông", "Điện tử có truyền thông"],
  ["Đồng hồ cơ", "Đồng hồ cơ"],
];

export const METER_BRANDS = [
  ["Siemens", "Siemens"],
  ["Schneider", "Schneider"],
  ["Panasonic", "Panasonic"],
...
export const METER_COLLECT_METHODS = [
  ["Thu thập dữ liệu tự động toàn bộ", "Thu thập dữ liệu tự động toàn bộ"],
  ["Thu thập dữ liệu tự động một phần", "Thu thập dữ liệu tự động một phần"],
  ["Chốt số thủ công", "Chốt số thủ công"],
];

export const METER_FREQUENCIES = [
  ["15 phút", "15 phút"],
  ["30 phút", "30 phút"],
  ["theo giờ", "Theo giờ"],
  ["theo ca", "Theo ca"],
...
export const METER_CALIB_STATUSES = [
  ["Kiểm định toàn bộ", "Kiểm định toàn bộ"],
  ["Kiểm định một phần", "Kiểm định một phần"],
  ["Hiệu chuẩn nội bộ toàn bộ", "Hiệu chuẩn nội bộ toàn bộ"],
  ["Hiệu chuẩn nội bộ từng phần", "Hiệu chuẩn nội bộ từng phần"],
  ["Chưa kiểm định/Hiệu chuẩn", "Chưa kiểm định/Hiệu chuẩn"],
];

export const AUDIT_HINTS = {
  general: {
    notes: ["Đã có tài liệu chuẩn", "Đang dự thảo, chờ phê duyệt", "Đã triển khai thực tế nhưng sơ sài", "Có hồ sơ ghi chép đầy đủ", "Chưa thực hiện / Không có biên bản", "Không thu thập được thông tin", "Dữ liệu cập nhật thiếu tính liên tục"],
    recs: ["Hoàn thiện quy trình bằng văn bản (SOP)", "Trình Giám đốc phê duyệt ban hành", "Đưa file quản lý lên hệ thống số hoá", "Phổ biến đến toàn bộ kỹ thuật viên", "Tổ chức lưu trữ hồ sơ theo quý"]
  },
  clause_4_5: {
    notes: ["Đánh giá rủi ro/bối cảnh chưa gắn với mảng năng lượng", "Ban QLNL hoạt động không có họp định kỳ", "Chưa phân rõ ai chịu trách nhiệm tiết kiệm % năng lượng", "Nhân sự Ban NL kiêm nhiệm không có thời gian", "Chưa truyền đạt Chính sách NL xuống các chuyền"],
    recs: ["Bổ sung rủi ro suy giảm năng lượng vào ma trận SWOT", "Xây dựng ma trận trách nhiệm RACI cho Ban NL", "Dán Bảng chính sách NL tại các phân xưởng chính", "Đưa mục tiêu NL vào KPIs cá nhân của Trưởng phòng"]
  },
  clause_6: {
    notes: ["Đánh giá mức tiêu thụ SEU chưa rõ dựa trên tải thực hay công suất máy", "Không xác định yếu tố tĩnh (công suất, diện tích) hay biến đổi (thời tiết, ca làm việc)", "Chưa thu thập đủ số liệu NL cho kỳ 12 tháng liên tục", "Mục tiêu chỉ tiêu NL chỉ là con số chung chung", "Chưa có danh mục các cơ hội tự định lượng (Action Plans)"],
    recs: ["Thu thập dữ liệu phụ tải từ đồng hồ lắp trên mảng SEU", "Xây dựng biểu đồ Pareto tối thiểu 80% NL", "Xác định Baseline qua hàm hồi quy đa biến", "Chia rõ mục tiêu KWh và TOE tiết kiệm mong đợi"]
  },
  clause_7: {
    notes: ["Thiếu kế hoạch đào tạo NL hàng năm", "Quy trình kiểm soát tài liệu chưa đánh mã kiểm soát phiên bản", "Không có ngân sách cụ thể cho phong trào tiết kiệm", "Giao tiếp tiếp nhận ý kiến cải tiến còn tắc nghẽn"],
    recs: ["Xây dựng lịch tập huấn cho 100% công nhân vận hành Boiler/Chiller, Nén khí", "Mở một hộp thư hoặc group chat tiếp nhận ý tưởng năng lượng do NV đóng góp", "Bổ sung mã kiểm soát tài liệu chuẩn (VD: QT.NL.01)"]
  },
  clause_8: {
    notes: ["Nhiều máy móc hỏng mới bảo dưỡng (Corrective Maintenance)", "Không có nhật ký thông số vận hành (áp suất, tỷ lệ O2/CO2)", "Quy chế mua sắm dự án chưa có tiêu chí chấm thầu bằng vòng đời (LCC) và Nhãn năng lượng", "Tái thiết kế nhà xưởng không quan tâm chiếu sáng tự nhiên và thông gió thụ động"],
    recs: ["Bắt buộc dùng tiêu chuẩn Vòng đời sản phẩm (LCC) vào mua máy điện", "Ban hành SOP: Áp suất máy nén tối đa 6.5 bar; Nhiệt chiller 7 độ", "Áp dụng kế hoạch bảo trì phòng ngừa định kỳ, bôi trơn motor"]
  },
  clause_9_10: {
    notes: ["Đồng hồ tổng và nhánh đã hết hạn kiểm định/hiệu chuẩn nội bộ", "Thiếu theo dõi sai lệch của EnPIs vs Baseline hàng tháng", "Lỗi và sự cố rò rỉ khí/hơi không được CAPA tận gốc", "Đánh giá nội bộ thiếu chuyên nghiệp (do thiếu kĩ năng ISO 50001)"],
    recs: ["Gắn lại các đồng hồ đo phụ tải còn thiếu ở xưởng / nhánh", "Ứng dụng Dashboard đo đếm trực tuyến để cảnh báo (IOT/Scada)", "Thực hiện họp Đánh giá Lãnh đạo tối thiểu 1 lần/năm với số liệu đầy đủ", "Mở khoá đào tạo chuyên gia đánh giá nội bộ"]
  }
};

export const getAuditHints = (clauseId) => {
  let cat = "general";
  if (!clauseId) return { notes: AUDIT_HINTS.general.notes, recs: AUDIT_HINTS.general.recs };
  if (clauseId.startsWith("4.") || clauseId.startsWith("5.")) cat = "clause_4_5";
  else if (clauseId.startsWith("6.")) cat = "clause_6";
  else if (clauseId.startsWith("7.")) cat = "clause_7";
  else if (clauseId.startsWith("8.")) cat = "clause_8";
  else if (clauseId.startsWith("9.") || clauseId.startsWith("10.")) cat = "clause_9_10";
  
  return {
    notes: Array.from(new Set([...AUDIT_HINTS.general.notes, ...(AUDIT_HINTS[cat]?.notes || [])])),
    recs: Array.from(new Set([...AUDIT_HINTS.general.recs, ...(AUDIT_HINTS[cat]?.recs || [])]))
  };
};
